...
## Current Version: [0.23.1](https://github.com/SolidNerd/docker-bookstack/blob/master/Dockerfile)
...
```bash
docker run --name my-bookstack -d --link bookstack-mysql:mysql -p 8080:80 solidnerd/bookstack:0.23.1
```
